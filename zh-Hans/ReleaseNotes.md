...
6.7.8 - 2026年1月16日
- 支持SQLite version 3.51.2 (2026-01-09)。
- 其它问题修复与稳定性改善。

6.7.7 - 2025年12月24日
- 数据编辑器。数据编辑器的默认字体大小现在将是标准系统字体大小。
- 数据库列表。显示数据库位置的默认值现在为真。
- 将SQLCipher更新到4.12.0。
- 额外的错误修复和稳定性改进。

6.7.6 - 2025年12月15日
- 修复一个编辑器使用不存在的字体时导致程序闪退的问题。
...
- 内部查看器。修复可能导致应用程序崩溃的问题。
- 内部查看器。支持在溢出页面上显示更多详细信息。
- 支持SQLite version 3.51.0 (2025-11-04)。
- 其它问题修复与稳定性改善。
