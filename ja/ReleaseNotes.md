...
6.7.7 - 2025年12月24日
- データエディター。データエディタのデフォルトのフォントサイズは、標準のシステムフォントサイズになります。
- データベースリスト。データベースの場所を表示のデフォルト値がtrueになりました。
- SQLCipherを4.12.0に更新します。
- 追加のバグ修正と安定性の改善。

6.7.6 - 2025年12月15日
- エディターがアンインストールされたフォントを使用している場合、アプリがクラッシュする問題を修正しました。

6.7.5 - 2025年12月7日
- SQLiteバージョン3.51.1（2025-11-28）をサポートします。
- SQLCipherライブラリをバージョン4.11.0に更新します。
- 追加のバグ修正と安定性の改善。

6.7.4 - 2025年11月6日
- 設定 - 一般では、SQLite ライブラリの日付 (ソースID から) の表示をサポートします。
- 仮想テーブルに認識されていないトークン化装置がある場合、データベースの読み込みが失敗する問題を修正します。
- エクスプローラーの内部。アプリのクラッシュにつながる可能性のある問題を修正します。
- エクスプローラーの内部。サポートはオーバーフローページの詳細を表示します。
- SQLiteバージョン3.51.0（2025-11-04）をサポートします。
- 追加のバグ修正と安定性の改善。

6.7.3 - 2025年10月14日
- ヘックスエディタ。UIのマイナーな改善。
- クエリをコピーします。クエリ終了フィールドの設定をサポートします。
- 追加のバグ修正と安定性の改善。
...
6.7.1 - 2025年8月15日
- SQLite version 3.50.4 (2025-07-30)をサポートします。
- SQLCipherライブラリをバージョン4.10.0に更新します。

6.7.0 - 2025年7月20日
- データベースパスを変更すると、アプリケーションがデータベースアクセス権限を失う可能性がある問題を修正しました。たとえば、iOSシミュレータでデータベースを開き、アプリケーションを再デプロイすると、SQLiteFlowは問題なくアクセスする必要があります。

6.6.9 - 2025年7月19日
- SQLite version 3.50.3（2025-07-17）をサポートします。

6.6.8 - 2025年6月29日
- SQLite version 3.50.2（2025-06-28）をサポートします。

6.6.7 - 2025年6月21日
- SQLite version 3.50.1（2025-06-06）をサポートします。
- SQLCipherライブラリをバージョン4.9.0に更新します。
- クエリエディタ。「最近貼り付け」は、メインメニューの「エディタ」でも利用可能になり、見つけやすくなります。
- 追加のバグ修正と安定性の改善。

6.6.6 - 2025年5月31日
- SQLite バージョン 3.50.0 (2025-05-29) をサポートします。
